...
from collective.bibliocustomviews.testing import (
    COLLECTIVE_BIBLIOCUSTOMVIEWS_FIXTURE as UNIT_TESTING,
    COLLECTIVE_BIBLIOCUSTOMVIEWS_INTEGRATION_TESTING as INTEGRATION_TESTING,
    COLLECTIVE_BIBLIOCUSTOMVIEWS_FUNCTIONAL_TESTING as FUNCTIONAL_TESTING,
    COLLECTIVE_BIBLIOCUSTOMVIEWS_SELENIUM_TESTING as SELENIUM_TESTING,
)
